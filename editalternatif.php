<?php 
    ...
    if(isset($_POST['edit_record'])){
        ...
        $id_a = $_GET['id']; 
        $alternatif_update = $saw->alternatif_update($nama_alternatif, $id_a);
        if($alternatif_update)
        {
            header('Location:alternatif.php');
        }
    }
                                ...
                                <div class="row mb-3 mt-3">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?=$data['nama_alternatif']?>" name="nama_alternatif" class="form-control">
                                        </div>
                                    </div>
                                </div>
